...
public class Minesweeper {
    ...
    public static int show(String showfield[][],int size) {
        ...
        for (int show = 0; show < size; show++) {
            ...
            for (int show2 = 0; show2 < size; show2++) {
                if (showfield[show][show2].equals("#")) {
                    System.out.print(ANSI_GREEN + showfield[show][show2] + ANSI_RESET);
                    System.out.print("  ");
                } else if (showfield[show][show2].equals("P")) {
                    System.out.print(ANSI_RED + showfield[show][show2] + ANSI_RESET);
                    System.out.print("  ");
                } else if (showfield[show][show2].equals("X")){
                    System.out.print(ANSI_BOLD + ANSI_RED + showfield[show][show2] + ANSI_RESET);
                    System.out.print("  ");
                } else if (!showfield[show][show2].equals("0")) {
                    System.out.print(ANSI_CYAN + showfield[show][show2] + ANSI_RESET);
                    System.out.print("  ");
                } else if (showfield[show][show2].equals("0")){
    ...
    public static int wincheck(boolean wincheck,boolean win,int wincheck1, int wincheck2, String[][] bombfield, String[][] showfield, int size){
        while (!wincheck) {
            if (bombfield[wincheck1][wincheck2].equals("0")) {
                if (!showfield[wincheck1][wincheck2].equals("#")) {
                    wincheck1++;
                    if (wincheck1 == size-1) {
                        wincheck1 = 0;
                        wincheck2++;
